...
class MetricTests extends ScalismoTestSuite {
  ...
  describe("The huber loss metric") {
    ...
    val sampler = GridSampler2D(DiscreteImageDomain(fixedImage.domain.boundingBox, size = IntVector(50, 50)))
