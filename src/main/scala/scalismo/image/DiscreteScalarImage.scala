...
//
//object DiscreteScalarImage {
//  implicit class DiscreteScalarImage1D[A: Scalar: ClassTag](discreteField: DiscreteField[_1D, n[_1D], data: ScalarArray[A]) extends DiscreteScalarImage[_1D, A](domain, data) {
//
