 ...
 */
case class TriangleMeshInterpolator[A: ValueInterpolator](mesh: TriangleMesh[_3D]) extends FieldInterpolator[_3D, A] {

  override def interpolate(field: DiscreteField[_3D, A]): Field[_3D, A] = {
