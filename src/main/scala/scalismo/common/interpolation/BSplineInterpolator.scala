...
import scalismo.image.{ BSplineCoefficients, DiscreteImageDomain }
...
object BSplineInterpolator {

  trait Create[D] {
    def createBSplineInterpolator[A: Scalar](degree: Int): BSplineInterpolator[D, A]
  }

  implicit object create1D extends Create[_1D] {
    override def createBSplineInterpolator[A: Scalar](degree: Int): BSplineInterpolator[_1D, A] = new BSplineInterpolator1D[A](degree)
  }

  implicit object create2D extends Create[_2D] {
    override def createBSplineInterpolator[A: Scalar](degree: Int): BSplineInterpolator[_2D, A] = new BSplineInterpolator2D[A](degree)
  }

  implicit object create3D extends Create[_3D] {
    override def createBSplineInterpolator[A: Scalar](degree: Int): BSplineInterpolator[_3D, A] = new BSplineInterpolator3D[A](degree)
  }
...
case class BSplineInterpolator1D[A: Scalar](degree: Int) extends BSplineInterpolator[_1D, A] {
  ...
  override def interpolate(discreteField: DiscreteField[_1D, DiscreteImageDomain[_1D], A]): DifferentiableField[_1D, A] = {
    ...
    new DifferentiableField[_1D, A](domain.boundingBox, f, df)
  }
...
case class BSplineInterpolator2D[A: Scalar](degree: Int) extends BSplineInterpolator[_2D, A] {
  ...
  override def interpolate(discreteField: DiscreteField[_2D, DiscreteImageDomain[_2D], A]): DifferentiableField[_2D, A] = {
    ...
    new DifferentiableField[_2D, A](discreteField.domain.boundingBox, f, df)
  }
...
case class BSplineInterpolator3D[A: Scalar](degree: Int) extends BSplineInterpolator[_3D, A] {
  ...
  override def interpolate(discreteField: DiscreteField[_3D, DiscreteImageDomain[_3D], A]): DifferentiableField[_3D, A] = {
    ...
    new DifferentiableField(BoxDomain3D(bbox.origin, bbox.oppositeCorner), f, df)
  }
