...
//
//    val yVecNoNan = yVec(nonNanEntries)
//    val mVecNoNan = mVec(nonNanEntries)
//
//    val QtLnoNan = QtL.delete(nanEntries, Axis._1)
//    val QnoNan = Q.delete(nanEntries, Axis._0)
//
//    val M = QtLnoNan * QnoNan + DenseMatrix.eye[Double](gp.klBasis.size)
//    val Minv = breeze.linalg.pinv(M)
//
//    (Minv, QtLnoNan, yVecNoNan, mVecNoNan)
//  }
