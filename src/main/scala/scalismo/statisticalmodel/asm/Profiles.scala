...
class DiscreteFeatureField[D <: Dim: NDSpace, Dom <: DiscreteDomain[D]](domain: Dom, _values: IndexedSeq[DenseVector[Double]])
    extends DiscreteField[D, Dom, DenseVector[Double]](domain, _values) {
...
object DiscreteFeatureField {
  def apply[D <: Dim: NDSpace, Dom <: DiscreteDomain[D]](domain: Dom, values: IndexedSeq[DenseVector[Double]]) = new DiscreteFeatureField[D, Dom](domain, values)
}
